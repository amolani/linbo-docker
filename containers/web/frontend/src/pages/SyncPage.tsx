...
import { RefreshCw, Play, RotateCcw, Eye, Loader2, AlertTriangle, HardDrive, Settings } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              {status?.isRunning ? (
                ...
                <span className="text-sm text-foreground">Bereit</span>
              )}
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">Offline-Timeout</span>
              <span className="text-sm text-foreground">{status?.hostOfflineTimeoutSec ?? '-'}s</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm text-foreground font-mono truncate max-w-[200px]" title={status?.cursor || ''}>
                {status?.cursor ? status.cursor.slice(0, 16) + '...' : '-'}
              </span>
            </div>
          </div>
        </div>
