...
// Mock Prisma to avoid import errors from remote.service
jest.mock('../../src/lib/prisma', () => ({
  prisma: {
    host: { findMany: jest.fn(), findFirst: jest.fn(), findUnique: jest.fn(), update: jest.fn() },
    operation: { create: jest.fn(), update: jest.fn() },
