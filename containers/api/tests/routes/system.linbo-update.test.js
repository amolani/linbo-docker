...
jest.mock('../../src/services/grub.service', () => ({
  regenerateAllGrubConfigs: jest.fn(async () => ({ configs: [], hosts: 0 })),
  listGrubConfigs: jest.fn(async () => []),
  cleanupOrphanedConfigs: jest.fn(async () => ({})),
  migrateHostConfigsToSymlinks: jest.fn(async () => ({})),
}));
...
jest.mock('../../src/workers/operation.worker', () => ({
